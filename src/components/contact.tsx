  ...
  return (
    <section className="relative overflow-hidden bg-muted py-20">
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold tracking-tighter text-primary sm:text-4xl">Get in Touch</h2>
      ...
      <div className="absolute inset-0 z-0 opacity-30">
        <svg className="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          {Array.from({ length: 50 }).map((_, i) => (
            <line key={i} x1={i * 2} y1="0" x2={i * 2} y2="100" stroke="#FFC799" strokeWidth="0.1" />
          ))}
        </svg>
      </div>
    </section>
